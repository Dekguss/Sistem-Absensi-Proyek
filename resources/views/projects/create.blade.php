...
<div class="min-vh-100">
    <div>
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="mb-4">
                    <h1 class="h3 fw-bold text-dark mb-2">Tambah Proyek Baru</h1>
                    <p class="text-muted mb-0">Lengkapi form di bawah untuk menambahkan proyek baru</p>
                </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="name" name="name" placeholder="Masukkan nama proyek" required />
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="location" class="form-control form-control-lg" placeholder="Masukkan lokasi proyek" required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="description" rows="4" class="form-control form-control-lg" placeholder="Deskripsi detail proyek..."></textarea>
                                    </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <input type="radio" class="btn-check" name="status" id="aktif" value="aktif" autocomplete="off" required>
                                            <label class="btn btn-outline-secondary btn-status w-100 py-2 d-flex align-items-center justify-content-center" for="aktif">
                                                <span>Aktif</span>
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="radio" class="btn-check" name="status" id="ditunda" value="ditunda" autocomplete="off" required>
                                            <label class="btn btn-outline-secondary btn-status w-100 py-2 d-flex align-items-center justify-content-center" for="ditunda">
                                                <span>Ditunda</span>
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="radio" class="btn-check" name="status" id="selesai" value="selesai" autocomplete="off" required>
                                            ...
                                            <div class="workers-list">
                                                ...
                                                <label class="form-check p-3 border-bottom border-opacity-25 hover-bg-gray-100 cursor-pointer d-block m-0">
                                                    <div class="form-check d-flex align-items-center">
                                                        ...
                                                        <input class="form-check-input me-3 worker-checkbox" type="checkbox" id="worker{{ $worker->id }}" name="workers[]" value="{{ $worker->id }}">
                                                        <div class="d-flex align-items-center">
